...
public class GlossaryService implements GlossaryResource {
    ...
    private void transferEntriesLocaleResource(
    ...
    private GlossaryTerm getGlossaryTerm(HGlossaryEntry hGlossaryEntry,
        HLocale locale) {
    ...
    private GlossaryEntry generateGlossaryEntry(HGlossaryEntry hGlossaryEntry) {
    ...
    private GlossaryTerm generateGlossaryTerm(HGlossaryTerm hGlossaryTerm) {
